<template>
  ...
  <button @click="$emit('clear')" class="btn btn-clear row-span-2">AC</button>
  ...
  <button @click="$emit('backspace')" class="btn btn-operators row-span-2">
    &laquo;
  </button>
...
<script setup>
defineEmits(["appendNumber", "clear", "backspace"])
</script>
